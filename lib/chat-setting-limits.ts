...
export const CHAT_SETTING_LIMITS: Record<LLMID, ChatSettingLimits> = {
  ...
  "llama3.1:latest": {
    MIN_TEMPERATURE: 0.0,
    MAX_TEMPERATURE: 1.0,
    MAX_TOKEN_OUTPUT_LENGTH: parseInt(process.env.NEXT_PUBLIC_DEFAULT_CONTEXT_LENGTH!, 10),
    MAX_CONTEXT_LENGTH: parseInt(process.env.NEXT_PUBLIC_DEFAULT_CONTEXT_LENGTH!, 10)
  },
  "llama4:scout": {
    MIN_TEMPERATURE: 0.0,
    MAX_TEMPERATURE: 1.0,
